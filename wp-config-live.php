...
define( 'WPCACHEHOME', 'http://tentables.net/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'tent_tweentables');

/** MySQL database username */
define('DB_USER', 'tent_aecadmin');

/** MySQL database password */
define('DB_PASSWORD', 'Amovementstartedwithtentables!');
